...
export default function KPICard({
    ...
    return (
        <div
            className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm transition-transform hover:scale-[1.01]">
            <div className="flex justify-between items-start mb-4">
                <div className={`p-2.5 ${bgColors[iconBgColor]} rounded-xl`}>
                    <Icon name={icon} className="block"/>
                </div>
                <span
                    className={`px-2 py-0.5 ${changeBgColor} text-[11px] font-bold rounded-full flex items-center gap-0.5`}>
          {change}{' '}
