            ...
            <div className="flex flex-col items-center gap-8">
                <div className="relative size-44">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                        ...
                        <span
                            className="text-[9px] text-slate-400 uppercase font-black tracking-widest mt-0.5">Active</span>
                    </div>
                </div>
                    ...
                    {categories.map((category, index) => (
                        <div key={index} className="flex items-center justify-between group cursor-default">
                            <div className="flex items-center gap-3">
                                <div
                                    className={`size-2 rounded-full ${getColorClass(category.color).split(' ')[1]} shadow-sm ${
