...
export default function TopNavLayout({ children, showSidebar = true }: TopNavLayoutProps) {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-background-light font-display text-slate-900">
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-solid border-slate-200 bg-white px-6 lg:px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          ...
          <div className="flex items-center gap-4 border-l border-slate-200 pl-8">
            ...
            <div
              className="bg-slate-200 bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border-2 border-blue-500/20"
              style={{
                backgroundImage:
          ...
          <aside className="hidden lg:flex w-64 flex-col border-r border-slate-200 bg-white p-4 gap-2">
            <div className="flex items-center gap-3 px-3 py-4 mb-2">
              ...
              <div className="flex flex-col">
                <h1 className="text-slate-900 text-sm font-bold">SalesTrain</h1>
                <p className="text-slate-500 text-xs font-normal">Панель управления</p>
              </div>
            </div>
            <Link
