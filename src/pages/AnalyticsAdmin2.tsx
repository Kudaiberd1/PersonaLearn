...
export default function AnalyticsAdmin2() {
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
          ...
          <div className="h-[340px] flex items-center justify-center relative">
            ...
            <div className="absolute right-0 top-1/3 text-right">
              <span className="text-[10px] font-black uppercase text-gray-500 tracking-tighter">Уверенность</span>
            ...
            <div className="absolute bottom-4 right-1/4 text-right">
              <span className="text-[10px] font-black uppercase text-gray-500 tracking-tighter">Возражения</span>
            ...
            <div className="absolute bottom-4 left-1/4 text-left">
              <span className="text-[10px] font-black uppercase text-gray-500 tracking-tighter">Эмпатия</span>
              <p className="text-xs font-bold">{analyticsData.radarData.fact.empathy}</p>
            </div>
            <div className="absolute left-0 top-1/3 text-left">
              <span className="text-[10px] font-black uppercase text-gray-500 tracking-tighter">Закрытие</span>
              ...
              return (
                <div key={gap.id} className={`p-4 ${colors.bg} border ${colors.border} rounded-lg`}>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {gap.trend && (
                      <span className={`text-xs font-black ${colors.bg.replace('50', '100').replace('900/10', '900/40')} px-2 py-0.5 rounded ${colors.text}`}>
