...
export default function TrainingMaterials2() {
  ...
  return (
    <PersonaLearnLayout title="Материалы обучения" showSearch>
      ...
      <div className="flex border-b border-[#dbe0e6] mb-8 overflow-x-auto scrollbar-hide">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div className="border-2 border-dashed border-[#dbe0e6] rounded-xl p-8 flex flex-col items-center justify-center bg-[#f6f7f8] hover:border-blue-500 transition-colors cursor-pointer">
                <Icon name="cloud_upload" className="text-4xl text-blue-500 mb-2" />
                <p className="text-sm font-semibold text-[#111418]">Выберите файл или перетащите его сюда</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select className="w-full bg-white border-[#dbe0e6] rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm px-4 py-2">
