  ...
  return (
    <PersonaLearnLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredMaterials.map((material) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-1">
              <h3 className="text-[#111418] font-bold text-lg leading-tight mb-2 line-clamp-2">
                {material.title}
              </h3>
        ...
        <div className="group border-2 border-dashed border-[#dbe0e6] rounded-xl flex flex-col items-center justify-center p-6 text-center hover:bg-white hover:border-blue-500 transition-all cursor-pointer min-h-[250px]">
