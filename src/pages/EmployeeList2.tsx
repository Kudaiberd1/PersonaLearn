...
export default function EmployeeList2() {
  ...
  return (
    <PersonaLearnLayout>
      <header className="h-20 flex items-center justify-between px-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200 dark:border-slate-800 -mx-8 -mt-8 mb-8">
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Список сотрудников</h2>
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            ...
            <input
              className="w-72 bg-slate-100 dark:bg-slate-800 border-none focus:ring-2 focus:ring-blue-500/20 rounded-xl pl-10 pr-4 py-2 text-sm"
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-sm">
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex -space-x-2">
              ...
              <div className="size-6 rounded-full border-2 border-white dark:border-slate-900 bg-slate-500"></div>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-sm">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 overflow-hidden">
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
              {employeesData.employees.map((employee) => (
                <tr key={employee.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                  ...
                  <td className="px-8 py-5 text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <button className="size-8 flex items-center justify-center text-slate-400 hover:text-slate-600 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all">
                        <Icon name="bar_chart" className="text-xl" />
                      </button>
                      <button className="size-8 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg transition-all">
        ...
        <div className="px-8 py-5 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 text-slate-400 hover:bg-white dark:hover:bg-slate-800">
            ...
            <button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 text-xs font-bold hover:bg-white dark:hover:bg-slate-800">
              2
            </button>
            <button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 text-xs font-bold hover:bg-white dark:hover:bg-slate-800">
              3
